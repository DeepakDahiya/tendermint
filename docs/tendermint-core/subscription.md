...
[List of events](https://godoc.org/github.com/deepakdahiya/tendermint/types#pkg-constants)
...
section](https://github.com/deepakdahiya/tendermint/blob/v0.34.x/spec/abci/abci.md#endblock) in
the ABCI spec).
