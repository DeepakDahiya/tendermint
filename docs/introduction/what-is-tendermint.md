...
(ABCI)](https://github.com/deepakdahiya/tendermint/tree/v0.34.x/abci)
...
[Tendermint Core](https://github.com/deepakdahiya/tendermint) (the
...
specification](https://github.com/deepakdahiya/tendermint/blob/v0.34.x/spec/abci/abci.md).
