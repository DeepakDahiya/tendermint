...
script](https://github.com/deepakdahiya/tendermint/blob/v0.34.x/networks/remote/integration.sh)
...
directory](https://github.com/deepakdahiya/tendermint/tree/v0.34.x/networks/remote/ansible)
