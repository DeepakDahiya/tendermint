...
import (
	...
	"github.com/deepakdahiya/tendermint/libs/async"
	"github.com/deepakdahiya/tendermint/libs/protoio"
	tmsync "github.com/deepakdahiya/tendermint/libs/sync"
	tmp2p "github.com/deepakdahiya/tendermint/proto/tendermint/p2p"
)
...
// See https://github.com/deepakdahiya/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/deepakdahiya/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/deepakdahiya/tendermint/issues/3531
