...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/deepakdahiya/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/deepakdahiya/tendermint/config/tendermint"
    * tmtypes "github.com/deepakdahiya/tendermint/types"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/deepakdahiya/tendermint/libs/bits"
