...
Official releases can be found [here](https://github.com/deepakdahiya/tendermint/releases).
...
- **Where to file issues:** <https://github.com/deepakdahiya/tendermint/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/deepakdahiya/tendermint/blob/v0.34.x/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/deepakdahiya/tendermint/blob/main/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/deepakdahiya/tendermint/blob/main/CONTRIBUTING.md) for more information.
